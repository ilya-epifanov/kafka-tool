...
trait PartitionReassignmentOp {
  def addBroker(currentReplication: TargetPartitionReplicationInfo,
                partitionsPerBroker: PartitionsPerBroker,
                allPartitionsPerBroker: PartitionsPerBroker): Option[BrokerId]

  def removeBroker(currentReplication: TargetPartitionReplicationInfo,
                   partitionsPerBroker: PartitionsPerBroker,
                   allPartitionsPerBroker: PartitionsPerBroker): Option[BrokerId]
}
